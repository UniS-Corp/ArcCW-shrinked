...
L["attslot.muzzle"] = "Дульное устройство"
L["attslot.barrel"] = "Barrel"
L["attslot.choke"] = "Choke"
L["attslot.underbarrel"] = "Тактические рукоятки"
...
L["attslot.skin"] = "Skin"
L["attslot.noatt"] = "Ничего"
L["attslot.optic.default"] = "Прицел по умолчанию"
L["attslot.muzzle.default"] = "Стандартный дульный компенсатор"
...
L["autostat.penetration"] = "Пробивание"
L["autostat.muzzlevel"] = "Скорость тряски"
L["autostat.meleetime"] = "Время рукопашной атаки"
L["autostat.meleedamage"] = "Урон рукопашной атаки"
L["autostat.meleerange"] = "Дальность рукопашной атаки"
L["autostat.recoil"] = "Вертикальная тряска"
L["autostat.recoilside"] = "Горизонтальная тряска"
L["autostat.firerate"] = "Скорострельность"
L["autostat.precision"] = "Точность"
L["autostat.hipdisp"] = "Разброс без прицеливания"
L["autostat.sightdisp"] = "Разброс при прицеливании"
L["autostat.movedisp"] = "Разброс при движении"
L["autostat.jumpdisp"] = "Разброс в прыжке"
L["autostat.barrellength"] = "Длина ствола"
L["autostat.shootvol"] = "Громкость выстрела"
L["autostat.speedmult"] = "Скорость"
...
L["autostat.magextender"] = "Размер увеличенного магазина"
L["autostat.magreducer"] = "Размер уменьшенного магазина"
L["autostat.bipod"] = "Can use Bipod"
L["autostat.holosight"] = "Прицел"
L["autostat.zoom"] = "Увеличенное прицеливание"
L["autostat.glint"] = "Блик прицела"
L["autostat.thermal"] = "Thermal vision"
L["autostat.silencer"] = "Подавление звука"
...
L["info.togglesight"] = "2 раза нажмите на кнопку взамодействия чтоюбы изменить обзор"
...
L["con.obstruction"] = "Перекрывает обзор"
...
L["fcg.semi"] = "Полуавто"
L["fcg.auto"] = "Авто"
L["fcg.burst"] = "%d-зарядная очередь"
L["fcg.ubgl"] = "UBGL"
...
L["fcg.safe.abbrev"] = "ПРЕДОХРАНИЕЛЬ"
L["fcg.semi.abbrev"] = "ПОЛУАВТОМАТИЧЕСКИЙ"
L["fcg.auto.abbrev"] = "АВТОМАТИЧЕСКИЙ"
L["fcg.burst.abbrev"] = "%d-ЗАЛП"
L["fcg.ubgl.abbrev"] = "UBGL"
L["fcg.safe2.abbrev"] = "LOW"
L["fcg.dact.abbrev"] = "DACT"
L["fcg.sact.abbrev"] = "SACT"
L["fcg.bolt.abbrev"] = "ОДИНОЧНЫЙ"
L["fcg.pump.abbrev"] = "ДРОБЬ"
